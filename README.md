...
It's used as a demo application to run static code analysis, software composition analysis and dynamic API scanning. Therec will be findings for alcl differnt type of scanning technologies.
Static Findings  
